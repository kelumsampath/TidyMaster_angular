...
import { ViewcusjobComponent } from './components/customer/viewcusjob/viewcusjob.component';
...
const applicationRoutes:Routes = [
  ...
  {path:'viewcusjob',component:ViewcusjobComponent, canActivate: [AuthGuard]},
];
